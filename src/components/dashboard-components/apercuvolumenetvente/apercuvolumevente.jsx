...
let lineData = {
    ...
    datasets: [{
        ...
        data: [0, 0, 12, 22, 8, 10, 5, 21]
    }]
};

const ApercuVolumeVente = () => {
    return (
        ...
        <CardBody>
            ...
            <div className="d-flex align-items-center">
                <div>
                    ...
                    <CardSubtitle >Volume net de vente </CardSubtitle>
                    <CardSubtitle >188,48 $</CardSubtitle>
                </div>
...
export default ApercuVolumeVente;
